...
Blockly.Blocks['mosio_get_value'] = {
    init: function() {
        this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldDropdown([["message body", "BODY"], ["valid format", "VALID"], ["last answer", "ANSWER"], ["survey id", "SURVEY_ID"], ["user id", "USER_ID"], ["survey state", "SURVEY_STATE"], ["microboard id", "MICROBOARD_ID"]]), "VALUE_NAME");
        this.setTooltip('');
